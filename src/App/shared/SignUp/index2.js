    ...
    <div className={Style.container}>
      <div className={Style.formContainer}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div>
            <i>Fullname :</i>
            <input type='text' name='fullname' placeholder='Fullname' onFocus={handleFocus} onBlur={handleBlur} onChange={handleChange} className={errors['fullname'] ? Style.warnBorder : ''} />
