...
export const topReadingArticlesReducer = (state = initialState, action) => {


  switch (action.type) {
    case GET_TOP_READING_ARTICLES_LOADING_START:
      return {
        ...state,
        isLoading: true,
      };

    case GET_TOP_READING_ARTICLES_FAILURE:
      return {
        ...state,
        error: { isError: true, msg: action.payload },
      };

    case GET_TOP_READING_ARTICLES_SUCCESS:
