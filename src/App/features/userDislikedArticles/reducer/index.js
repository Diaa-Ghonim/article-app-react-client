...
export const userDislikedArticlesReducer = (state = initialState, action) => {


  switch (action.type) {
    case GET_USER_DISLIKED_ARTICLES_LOADING_START:
      return {
        ...state,
        isLoading: true,
      };

    case GET_USER_DISLIKED_ARTICLES_FAILURE:
      return {
        ...state,
        error: { isError: true, msg: action.payload },
      };

    case GET_USER_DISLIKED_ARTICLES_SUCCESS:
