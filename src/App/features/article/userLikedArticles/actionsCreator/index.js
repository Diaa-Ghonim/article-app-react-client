...
const getUserLikedArticlesSuccess = createAction(
  GET_USER_LIKED_ARTICLES.SUCCESS,
  'articles'
);
const getUserLikedArticlesFailure = createAction(
  GET_USER_LIKED_ARTICLES.FAILURE,
  'error'
);
const getUserLikedArticlesLoadingStart = createAction(
  GET_USER_LIKED_ARTICLES.LOADING
);
