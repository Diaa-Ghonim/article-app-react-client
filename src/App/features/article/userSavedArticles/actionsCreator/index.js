...
const getUserSavedArticlesSuccess = createAction(
  GET_USER_SAVED_ARTICLES.SUCCESS,
  'articles'
);
const getUserSavedArticlesFailure = createAction(
  GET_USER_SAVED_ARTICLES.FAILURE,
  'error'
);
const getUserSavedArticlesLoadingStart = createAction(
  GET_USER_SAVED_ARTICLES.LOADING
);
