        ...
        <form onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <input
              ...
              onBlur={(e) => !validateFullname(fullname) ? setFullnameError('fill input') : ''}
              value={fullname}
          ...
          <div className={Style.birthContainer}>
            ...
            {birthDayError || birthMonthError || birthYearError ? <SvgValidateWarn className={Style.svgWarnSelect} /> : ''}
            ...
            <div className={Style.selectContainer}>
              ...
              <select
                value={birthDay}
                name='day'
                onBlur={(e) => !birthDay ? setBirthDayError('fill input') : ''}
              ...
              <select
                value={birthMonth}
                name='month'
                onBlur={(e) => !birthMonth ? setBirthMonthError('fill input') : ''}
              ...
              <select
                value={birthYear}
                name='year'
                onBlur={(e) => !birthYear ? setBirthYearError('fill input') : ''}
          ...
          <div>
            ...
            {genderError ? <SvgValidateWarn className={Style.svgWarnSelect} /> : ''}
