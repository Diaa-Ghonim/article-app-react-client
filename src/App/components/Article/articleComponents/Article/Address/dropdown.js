...
export class dropdown extends Component {
  ...
  handleDeleteArticle = () => {
    this.props.deleteArticle(this.props.data.id)
  } 
  ...
  render() {
    return (
      <>
        <div className={Style.dropdown} ref={this.dropdown}>
          
          <div className={Style.listContainer} onClick={this.handleDeleteArticle}>
